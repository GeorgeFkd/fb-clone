...
const  MessengerOptionsDropdownRow:React.FC<Props> = ({ Icon, text, hasButton, helpingText }) => {
    ...
    const IOSSwitch = withStyles((theme) => ({
        ...
        checked: {},
        focusVisible: {},
        //!https://stackoverflow.com/questions/47466060/typescript-material-ui-property-classes-is-missing-in-type-for-mui-component
        //!check it out again
    }))(({ classes, ...props }) => {
        return (
            <Switch
