...
const  MessengerDropdown:React.FC<Props> = () => {
    const [session] = useSession();
    const [optionsOpen, setOptionsOpen] = useState(false);
    //? somehow get it a Chat[]
        ...
        <>
            ...
            >
                ...
                <MessengerRow
                    ...
                    isNotRead={true}
                    handleClick={() =>
                        openChat({chatImg: session.user.image,chatName: session.user.name})
                    }
                />
                <MessengerRow
                    imgSrc={session.user.image}
                    ...
                    isNotRead={false}
                    handleClick={() =>
                        openChat({chatImg:session.user.image,chatName: "Τμήμα Εφαρμοσμένης"})
                    }
                />
                <MessengerRow
                    imgSrc={session.user.image}
                    ...
                    isNotRead={false}
                    handleClick={() =>
                        openChat({chatImg:session.user.image, chatName:"Guantanamo"})
                    }
                />
                <hr />
