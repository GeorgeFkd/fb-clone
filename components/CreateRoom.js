...
function CreateRoom({ avatarSrc }) {
    ...
    const checkIfReachedMax = (scrollDiv) => {
        if (
    ...
    const scrollRoomUsers = (e, scrollLeftAmount) => {
        const containerDiv = document.querySelector("#createRoomContainer");
        console.log();
        const scrollDiv = document.querySelector("#roomUsersContainer");
