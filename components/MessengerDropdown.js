...
function MessengerDropdown() {
  ...
  return (
    <>
      {/* appbar and search  */}
      <div
        className="flex flex-col space-y-2 border-2 border-yellow-600 bg-gray-800"
        style={{ position: "absolute", top: "3.3rem", right: "-5rem" }}
      >
        <div className="flex items-center">
          <h1 className="mr-auto text-white" style={{ fontSize: "2rem" }}>
            Messenger
          </h1>
          <div
          ...
          >
            ...
            <LightTooltip title="See All in messenger" placement="bottom-start">
              <FullscreenIcon
                fontSize="large"
                className="rounded-full hover:bg-gray-600 p-1 cursor-pointer "
                style={{ color: "yellow" }}
            ...
            <LightTooltip title="Create New Room" placement="bottom-start">
              <VideoCallIcon
                fontSize="large"
                className="rounded-full hover:bg-gray-600 p-1 cursor-pointer "
                style={{ color: "yellow" }}
            ...
            <LightTooltip title="New Message" placement="bottom-start">
              <CreateIcon
                fontSize="large"
                className="rounded-full hover:bg-gray-600 p-1 cursor-pointer "
                style={{ color: "yellow" }}
